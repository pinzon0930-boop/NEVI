...
export default function GrupoDetalle() {
  ...
  // Obtiene el perfil y cerrarSesion del contexto global (limpia estado React + localStorage)
  ...
  async function handleLogout() {
    await cerrarSesion()   // Limpia estado React + elimina nevi_token/nevi_user de localStorage
    navigate('/login')
  }
              ...
              {cargandoChat ? (
                ...
                <div className="space-y-4">
                  {mensajes.map((mensaje, index) => {
                    const esMio = mensaje.userId === perfil?.id            // true si el mensaje es del usuario actual
                    ...
                    const mismoDueno = mensajeAnterior?.userId === mensaje.userId // true si es el mismo autor
